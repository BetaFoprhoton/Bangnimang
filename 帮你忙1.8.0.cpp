...

{
	...
	else
	{
		...
		getchar();
			...
			system("color F2");
			system("cls");
			printf("您可以在程序启动时进入错误代码查询系统查找解决方法。（如下图）\n");
			printf("是否进入错误代码查询系统？y/n\n\n");
			printf("y<---输入“y”以进入。\n");
			printf("请按ENTER以继续。");
			getchar();
		    }
		    ...
		    {
		    	system("cls");
		    	printf("在程序加载时，会显示更新公告，您可以在这里了解帮你忙更新内容。（如下图）\n");
	printf(" |--------------------更新公告--------------------| \n");
	printf(" |---------------以下为本次更新内容---------------| \n");
		...
		if(b%7==0)
{
		...
		fprintf(fp,"帮你忙v1.8.0:判断%d能否被7整除，结果为能。\n",b);
		...
		if(b%7!=0)
{
		...
		fprintf(fp,"帮你忙v1.8.0:判断%d能否被7整除，结果为不能。\n",b);
		...
		if(c%11==0)
{
		...
		fprintf(fp,"帮你忙v1.8.0:判断%d能否被11整除，结果为能。\n",c);
	    ...
	    if(x==1)
{
		...
		fprintf(fp,"帮你忙v1.8.0:加法计算器%lf加%lf等于%lf\n",la,ka,ra);
        ...
        if(x==2)
{
		...
		fprintf(fp,"帮你忙v1.8.0:减法计算器%lf减%lf等于%lf\n",lb,kb,rb);
        ...
        if(x==3)
{
		...
		fprintf(fp,"帮你忙v1.8.0:乘法计算器%lf乘%lf等于%lf\n",l,k,r);
        ...
        if(x==4)
{
		...
		fprintf(fp,"帮你忙v1.8.0:除法计算器%lf除以%lf等于%lf\n",lc,kc,rc);
        ...
        if(a==4)
{
		...
		if(count==0)
		    ...
		    fprintf(fp,"帮你忙v1.8.0:判断质合数数字%d结果为质数\n",ssr);
		...
		if(count!=0)
		    ...
		    fprintf(fp,"帮你忙v1.8.0:判断质合数数字%d结果为合数\n",ssr);
	      ...
	      if(cccp==1)
{
	        ...
	        fp=fopen("TBS.txt","a");
	      	...
	      	fprintf(fp,"帮你忙v1.8.0:圆周长计算圆周率为3.14，半径为%lf结果为%lf\n",m100,m39);
		    ...
		    if(cccp==2)
{
	        ...
	        fp=fopen("TBS.txt","a");
	      	...
	      	fprintf(fp,"帮你忙v1.8.0:圆周长计算圆周率为3.1415926，半径为%lf结果为%lf\n",m40,m41);
	...
	scanf("%d",&op);
	      if(op==1)
	      {
	        ...
	        fp=fopen("TBS.txt","a");
	      	...
	      	fprintf(fp,"帮你忙v1.8.0:圆面积计算圆周率为3.14，半径为%lf结果为%lf\n",fd,mmp);
		  ...
		  if(op==2)
		  {
	        ...
	        fp=fopen("TBS.txt","a");
	      	...
	      	fprintf(fp,"帮你忙v1.8.0:圆面积计算圆周率为3.1415926，半径为%lf结果为%lf\n",m10,m12);
